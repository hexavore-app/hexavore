...
**À gauche du plat, sa photo** quand il en a une ([D127](11-decisions.md)) : une vignette carrée de 56 dp, arrondie, qui dit *quel repas* mieux qu'un titre déduit de l'heure. Elle n'est là que quand elle existe, sans emplacement réservé : caler chaque titre d'une journée entière pour un seul plat photographié coûterait plus qu'elle ne rapporte. Elle est décorative pour un lecteur d'écran, puisque le nom, l'heure et les calories sont juste à côté.
...
**Entre l'en-tête et les lignes, la photo** quand ce brouillon en a une : celle qu'un scan a figée, celle qu'une analyse vient d'envoyer, ou celle du plat qu'on rouvre ([D127](11-decisions.md)). Un carré de 132 dp, aligné à gauche : ce qu'on vient faire ici est corriger des quantités, et la photo est un repère — *c'est bien ce repas-là* — pas un objet à examiner. **Une croix en haut à droite la retire**, à la même place que sur le cadre de l'écran d'IA. Elle n'efface rien tout de suite : le fichier part à l'enregistrement, parce qu'annuler doit rendre le plat tel qu'il était.
...
**Photos des plats** — un interrupteur, ce que les images occupent, et de quoi les effacer ([D127](11-decisions.md)). Juste après **Sauvegarde**, parce que les deux parlent de ce que l'application garde sur le téléphone et de ce qu'on peut en retirer. **Deux gestes et non un** : l'interrupteur décide de ce qui s'écrira, le bouton efface ce qui est écrit, et les fondre aurait fait disparaître des mois d'images à qui voulait seulement cesser d'en accumuler. Le poids est dit, parce que « garder les photos » ne veut rien dire tant qu'on ne sait pas ce que ça coûte.
